...
const DynamicPricing = () => {
  return (
    <div className=" h-[35vh] w-[60vw] overflow-hidden">
      ...
      <div className="px-[1vw] text-white h-full w-full">
        <div className="w-full">
          <table className="w-full border-collapse">
            ...
            <tbody className="flex flex-col gap-2 h-[10rem] sm:h-[20vh] overflow-y-scroll scrollbar-hide">
              {[...Array(15)].map((_, index) => (
                <tr
                  key={index}
                  className="bg-white/10  text-[10px] md:text-lg lg:text-[1vw] flex justify-between items-center rounded-[1vw] px-[0.5vw] py-[1vh]"
                >
