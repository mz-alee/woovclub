...
const DynamicPricing = () => {
  return (
    <div className=" border border-gray-600 rounded-xl h-[30vh] sm:h-[40vh] w-full overflow-hidden">
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="flex flex-col gap-2 h-[10rem] sm:h-[25vh] overflow-y-scroll scrollbar-hide">
              {[...Array(15)].map((_, index) => (
                <tr
                  key={index}
                  className="bg-white/10  hover:bg-[#652ebd] text-[10px]  lg:text-[1vw]  flex justify-between items-center gap-2 rounded-[1vw] px-[0.5vw] sm:py-[1vh]"
                >
