...
const TotalTickets = () => {
  return (
    <div className="total-ticket px-[1.5vw] h-[17rem] w-[70vw] sm:w-[60vw] md:w-[35vw] md:h-[25vh] lg:w-[25vw] lg:h-[35vh] ">
      ...
      <div className="ticket-detail w-full flex flex-col  h-[24vh]  py-4 justify-between items-center ">
