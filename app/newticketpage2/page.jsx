...
const newticketpage3 = () => {
  ...
  return (
    <div className=" md:overflow-y-hidden  ticket-page w-full min-h-[90vh]  text-white grid md:grid-cols-12">
        ...
        <div className="leftside md:w-[25vw]  h-full   flex flex-col items-center py-[0.5vh] gap-[1vw] ">
          <div className="flex  items-center gap-[1.5vw] py-[1.5vw] ">
            <button
              ...
              className={`${poppins.className} font-[600] bg-[#45b7db] w-fit h-[5vh] text-[10px] md:text-[10px] flex items-center gap-[0.5vw] text-black rounded-2xl px-[1vw] py-[1vh]`}
            >
              <MdOutlineKeyboardArrowLeft className="text-[13px] font-light" />
              Tickets Management
            </button>
            <h1
              className={`${poppins.className} italic text-sm md:text-[1vw] lg:text-md`}
            >
              Create New Tickets
            </h1>
            <Pagecount/>
        ...
        <div className="setting flex flex-col gap-2 ">
          ...
          <div className="setting-container px-[1vw] py-[1vh] text-black bg-[#ededed] w-full min:h-[80vh] rounded-[1.5vw]  ">
            ...
            <div className="border-b border-gray-400 w-full h-[12vh]  flex justify-between items-center">
              ...
              {/* dropdownlist  */}
              <div className="dropdownlist bg-[#45b7db] rounded-[1.5vw] h-[7vh] min:w-[15vw]  md:h-[7vh] md:w-[8vw] py-2 flex justify-between items-center px-2">
            ...
            <div className="border-b border-gray-400 w-full h-[12vh]  flex justify-between items-center">
              ...
              {/* dropdownlist  */}
              <div className="dropdownlist bg-[#45b7db] rounded-[1.5vw] h-[7vh] min:w-[15vw]  md:h-[7vh] md:min-w-[8vw] py-2 flex justify-between items-center px-2">
